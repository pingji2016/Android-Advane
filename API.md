...
```json
{
  ...
  "x": 0.5,
  "y": 0.5,
  "duration": 600 // [可选] 按住时长(毫秒)，默认 600ms
}
```

#### 1.2.4 双击 (Double Click)
在指定位置执行双击，间隔可调。
...
```json
{
  ...
  "x": 0.5,
  "y": 0.5,
  "interval": 120 // [可选] 两次点击间隔(毫秒)，默认 120ms
}
```

#### 1.2.5 文本输入 (Text Input)
